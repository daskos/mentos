...
from malefico.core.messages import (CommandInfo, ContainerInfo, Cpus, Disk,
                                    Mem, TaskID, TaskInfo)
from malefico.core.scheduler import MesosMesosSchedulerDriver
from malefico.scheduler import QueueScheduler
from malefico.utils import RemoteException
...
def test_command(mocker, command):
    ...
    with MesosMesosSchedulerDriver(sched, name='test-scheduler'):
